...
Le projet **Émotion** est un projet où l'on avait comme défi d'intégrer des formes à l'intérieur de celui-ci. Dans notre projet, j'ai eu l'idée de cassé des miroirs afin qu'elle crée à la fois des formes comme demander mes aussi de différents fragments qui apporte de différentes ombres. De plus, nous avons aussi pour défi utilisé un green screen. Nous avons utilisé les green screen pour faire apparaitre des mains dans le visages de Anna afin de créer un effet d'oppression 
